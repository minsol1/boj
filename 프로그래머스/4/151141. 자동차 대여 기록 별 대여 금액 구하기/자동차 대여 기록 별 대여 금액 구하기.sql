# select truc.HISTORY_ID, day*DAILY_FEE*(1-0.01* ifnull(max(dr),0)) FEE
...
#      left join (select substring_index(DURATION_TYPE,'일',1)dt, substring_index(DISCOUNT_RATE,'%',1) dr
